...
#   See: http://stackoverflow.com/questions/1549801/differences-between-isinstance-and-type-in-python

######################################################################

def msg_int( i ):
    print "Debug: msg_int: i={}".format( i )
    if i >= 100:
        print "That's a big number1"
    else:
...
def msg_str( s ):
    print "Debug: msg_str: s={}".format( s )
    if len( s ) >= 50:
        print "Long sentence."
    else:
...
def msg_list( l ):
    print "Debug: msg_list: l={}".format( l )
    if len( l ) >= 10:
        print "Big list!"
    else:
        print "Short list."
