...
We've learned about how we can:
- connect to the database
- insert records posted from a form
- retrieve records from a database
- set a session/flash for any error or success messages that we get along the way
...
- We verify that the information is correct
  - If verification is successful
    ...
    - We return with a success message
  - If verification is NOT successful
    - We redirect to the registration page and show the following requirements:
