...
# This class will give us an object that we can use to connect to a database
...
# This method is to be called in server.py.
# NOTE: Make sure to provide the db name!
